...
cp "automation/alma-iso/ks.cfg" "$ISO_DIR/ks.cfg"

cp "automation/alma-iso/grub.cfg" "$ISO_DIR/EFI/BOOT/grub.cfg"

cp "automation/alma-iso/isolinux.cfg" "$ISO_DIR/isolinux/isolinux.cfg"
